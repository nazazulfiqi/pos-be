    ...
    "paths": {
        ...
        "/stock-movements/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Stock Movement Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.StockMovementCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.PayTransactionRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.PayTransactionResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "dto.CreateCategoryRequest": {
            ...
            "properties": {
                ...
                "tenant_id": {
                    "description": "Menambahkan tenant_id sebagai field yang wajib diisi",
                    "type": "string"
                }
            }
        },
        ...
        "dto.StockMovementCreateRequest": {
            "type": "object",
            "required": [
                "product_id",
                "quantity",
            ...
            "properties": {
                ...
                "reference_type": {
                    "description": "contoh: \"transaction\", \"order\", \"purchase\"",
                    "type": "string"
                },
                "tenant_id": {
                    "type": "string"
                ...
                "type": {
                    "description": "validasi hanya \"in\" atau \"out\"",
                    "type": "string",
                    "enum": [
                        "in",
                        "out"
